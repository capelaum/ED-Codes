// Funções da arvore BST do prof

#include "BST.h"
#include "Fila.h"

//=======================================================
t_no* busca ( t_no* raiz, int dado){ // Busca - recursiva
...
t_no* busca_pai (t_no* raiz, int dado){
   ...
   return NULL; // Sem isso da warning
} //end busca_pai()
//=======================================================
...
//=======================================================
t_no* aloca_no (int dado){ // aloca o no
...
//=======================================================
t_no* inserir (t_no* raiz, int dado){// Inserir -  recursivo 
    ...
    if (raiz == NULL) {
        ...
        } // inserir no ptr direito da arvore
...
void percurso_largura (t_no* raiz){
    ...
    while(!esta_vazia (fila)){
        ...
        if(no->esq != NULL)
            inserir_na_fila (no->esq, fila);

        if(no->dir != NULL)
            inserir_na_fila (no->dir, fila);
