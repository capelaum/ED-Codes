...
// Arquivo Main da implementacao da codificacao de Huffman
...
// Insere ordenadamente por frequencia na Lista 
...
//=============================================================================================
    ...
    // Raiz interna do Passo 1
    printf("======================================\n");

    printf("Quantidade de nos na arvore raiz: %d\n", qtd (raiz) );
    pre_ordem (raiz);

    // Raiz interna do Passo 2    
    printf("======================================\n");

    printf("Quantidade de nos na arvore raiz_%d: %d\n",cont++, qtd (raiz_1) );
    pre_ordem (raiz_1);

    // Raiz interna do Passo 3   
    printf("======================================\n");

    printf("Quantidade de nos na arvore raiz_%d: %d\n",cont++, qtd (raiz_2) );
    pre_ordem (raiz_2);

    // Raiz interna do Passo 4   
    printf("======================================\n");

    printf("Quantidade de nos na arvore raiz_%d: %d\n",cont++, qtd (raiz_3) );
    pre_ordem (raiz_3);

    // Raiz de toda arvore do ultimo Passo 5   
    printf("======================================\n");
    ...
    // Libera memoria da Arvore de Huffman
